" Redistributed From the original MIT licensed One Half Dark colorscheme: 
"
" ==============================================================================
"   Name:        One Half Dark
...
let g:colors_name="db_onehalfdark"
...
let s:gutter_bg   = { "gui": "#16181c", "cterm": "236" }
let s:gutter_fg   = { "gui": "#3c3f41", "cterm": "247" }
let s:non_text    = { "gui": "#3c3f41", "cterm": "239" }

let s:cursor_line = { "gui": "#24272a", "cterm": "237" }
let s:color_col   = { "gui": "#3c3f41", "cterm": "237" }

let s:selection   = { "gui": "#3c3f41", "cterm": "239" }
let s:vertsplit   = { "gui": "#3c3f41", "cterm": "237" }
